...
public final class ClientVoiceConfig {
    ...
    /** Canonical en-us alias of {@link #ENGINE_VOSK} (models.json engine binding). */
    public static final String ENGINE_VOSK_EN_US = "vosk-en-us";
    ...
    public static boolean isValidEngine(String e) {
        return ENGINE_VOSK.equals(e) || ENGINE_VOSK_EN_US.equals(e) || ENGINE_IPA.equals(e);
    }

    /** Accept vosk/ipa aliases incl. the en-us language tag; null if unknown. */
    public static String normalize(String s) {
        if (s == null) return null;
        return switch (s.toLowerCase(java.util.Locale.ROOT)) {
            case "vosk", "text", "vosk-text", "word", "vosk-en-us", "en-us", "en", "english" -> ENGINE_VOSK;
    ...
    public static ClientVoiceConfig load(Path runDir) {
        ...
        if (isValidEngine(eng)) c.engine = eng;
